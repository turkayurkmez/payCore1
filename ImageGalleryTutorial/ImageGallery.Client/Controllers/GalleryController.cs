...
namespace ImageGallery.Client.Controllers
{
    ...
    public class GalleryController : Controller
    {
        ...
        private async Task LogIdentityInfo()
        {
            ...
            var useClaimsStringBuilder = new StringBuilder();
            User.Claims.ToList().ForEach(claim => useClaimsStringBuilder.AppendLine($"Claim type:{claim.Type} Claim value: {claim.Value}"));

            _logger.LogInformation($"Identity token ve claim bilgileri: {identityToken} \n{useClaimsStringBuilder}");
        }
